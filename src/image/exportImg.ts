import BootStrapImg from './bs.svg';
import JavaScriptImg from './js.svg';
import TypeScriptImg from './ts.svg';
import ReactImg from './re.svg';
import NextJsImg from './ne.svg';
import ReactQueryImg from './rq.svg';
import Avatar from './title1.png';
import YoriJoriLogo from './YoriJoriLogo.png';
